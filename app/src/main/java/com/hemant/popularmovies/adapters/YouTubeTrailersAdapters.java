...
public class YouTubeTrailersAdapters extends RecyclerView.Adapter<YouTubeTrailersAdapters.TrailerHorizontalViewHolder> {
    ...
    public void onBindViewHolder(TrailerHorizontalViewHolder holder, int position) {
        String trailerNo = holder.itemView.getContext().getString(R.string.TrailerNo,String.valueOf(position + 1));
        holder.textViewTrailerName.setText(trailerNo);
        try {
            ...
            holder.imageViewTrailerPoster.setContentDescription(trailerNo);
