...
import com.hemant.popularmovies.databinding.ActivityMovieDetailsBinding;
...
public class MovieDetailsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks,
        YouTubeTrailersAsyncTaskListener, MovieReviewAsyncTaskListener, YouTubeTrailersAdapters.OnTrailerItemClickListener,
        MovieReviewsAdapters.OnMovieReviewItemClickListener, AsyncTaskCallbackListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityMovieDetailsBinding.tvDetailsRatings.setText(String.format("%s%s", movieDetails.getRatings(), getString(R.string.hyphen10)));
        activityMovieDetailsBinding.tvDetailsReleaseDate.setText(movieDetails.getReleaseDate());
        activityMovieDetailsBinding.tvDetailsSynopsis.setText(movieDetails.getSynopsis());
        Picasso.with(this).load(movieDetails.getImagePath()).into(activityMovieDetailsBinding.ivDetailsMoviePoster);
        activityMovieDetailsBinding.ivDetailsMoviePoster.setContentDescription(getString(R.string.MoviePoster_a11y, movieDetails.getTitle()));
        assert getSupportActionBar() != null;
        getSupportActionBar().setTitle(movieDetails.getTitle());
        activityMovieDetailsBinding.tvDetailsTitle.setText(movieDetails.getTitle());
        mMovieId = String.valueOf(movieDetails.getMovieId());
        activityMovieDetailsBinding.trailerReviewLayout.buttonTryAgain.setOnClickListener(this);
        activityMovieDetailsBinding.fabActionAddToFavorite.setOnClickListener(this);
        setupRecyclerViews();
    }
    ...
    private void setupRecyclerViews() {
        ...
        activityMovieDetailsBinding.trailerReviewLayout.recyclerViewMovieReviews.setLayoutManager(linearLayoutManagerReview);
        activityMovieDetailsBinding.trailerReviewLayout.recyclerViewMovieReviews.setHasFixedSize(true);
        movieReviewsAdapters = new MovieReviewsAdapters(this);
        activityMovieDetailsBinding.trailerReviewLayout.recyclerViewMovieReviews.setAdapter(movieReviewsAdapters);
        ...
        activityMovieDetailsBinding.trailerReviewLayout.recyclerViewYouTubeTrailers.setLayoutManager(linearLayoutManagerYouTube);
        activityMovieDetailsBinding.trailerReviewLayout.recyclerViewYouTubeTrailers.setHasFixedSize(true);

        youTubeTrailersAdapters = new YouTubeTrailersAdapters(this);
        activityMovieDetailsBinding.trailerReviewLayout.recyclerViewYouTubeTrailers.setAdapter(youTubeTrailersAdapters);
    }
    ...
    private void showYouTubeLoadingIndicator() {
        activityMovieDetailsBinding.trailerReviewLayout.recyclerViewYouTubeTrailers.setVisibility(View.INVISIBLE);
        activityMovieDetailsBinding.trailerReviewLayout.progressBarYouTubeTrailer.setVisibility(View.VISIBLE);
        activityMovieDetailsBinding.trailerReviewLayout.textViewErrorLoading.setVisibility(View.GONE);
        activityMovieDetailsBinding.trailerReviewLayout.buttonTryAgain.setVisibility(View.GONE);
        activityMovieDetailsBinding.trailerReviewLayout.textViewNoYouTubeTrailer.setVisibility(View.GONE);
    }
    ...
    private void showReviewLoadingIndicator() {
        activityMovieDetailsBinding.trailerReviewLayout.recyclerViewMovieReviews.setVisibility(View.INVISIBLE);
        activityMovieDetailsBinding.trailerReviewLayout.progressBarMovieReviews.setVisibility(View.VISIBLE);
        activityMovieDetailsBinding.trailerReviewLayout.textViewNoReviewsFound.setVisibility(View.GONE);
    }
    ...
    private void showErrorFetchingTrailers() {
        activityMovieDetailsBinding.trailerReviewLayout.progressBarYouTubeTrailer.setVisibility(View.GONE);
        if (isConnected()) {
            activityMovieDetailsBinding.trailerReviewLayout.textViewNoYouTubeTrailer.setVisibility(View.VISIBLE);
        } else {
            activityMovieDetailsBinding.trailerReviewLayout.buttonTryAgain.setVisibility(View.VISIBLE);
            activityMovieDetailsBinding.trailerReviewLayout.textViewErrorLoading.setVisibility(View.VISIBLE);
        }
    }

    private void showErrorFetchingReviews() {
        activityMovieDetailsBinding.trailerReviewLayout.progressBarMovieReviews.setVisibility(View.GONE);
        activityMovieDetailsBinding.trailerReviewLayout.textViewNoReviewsFound.setVisibility(View.VISIBLE);
        if (isConnected()) {
            activityMovieDetailsBinding.trailerReviewLayout.textViewNoReviewsFound.setText(getString(R.string.NoMovieReviewsFound));
        } else {
            activityMovieDetailsBinding.trailerReviewLayout.textViewNoReviewsFound.setText(getString(R.string.UnableToConnectToInternet));
        }
    }

    private void showReviewUI() {
        activityMovieDetailsBinding.trailerReviewLayout.recyclerViewMovieReviews.setVisibility(View.VISIBLE);
        activityMovieDetailsBinding.trailerReviewLayout.progressBarMovieReviews.setVisibility(View.GONE);
    }

    private void showYoutubeUI() {
        activityMovieDetailsBinding.trailerReviewLayout.recyclerViewYouTubeTrailers.setVisibility(View.VISIBLE);
        activityMovieDetailsBinding.trailerReviewLayout.progressBarYouTubeTrailer.setVisibility(View.GONE);
    }
    ...
    public void onAsyncTaskPreExecute(MovieDetailsAsyncTasks.TaskType taskType) {
        switch (taskType) {
            case FIND_MOVIE_ID:
                activityMovieDetailsBinding.fabActionAddToFavorite.setClickable(false);
                activityMovieDetailsBinding.fabActionAddToFavorite.setVisibility(View.GONE);
                break;
    ...
    public void onAsyncTaskPostExecute(Boolean result, MovieDetailsAsyncTasks.TaskType taskType) {
        switch (taskType) {
            case FIND_MOVIE_ID:
                activityMovieDetailsBinding.fabActionAddToFavorite.setVisibility(View.VISIBLE);
            case INSERT_FAV_MOVIE:
                activityMovieDetailsBinding.fabActionAddToFavorite.setClickable(true);
                favoriteMovie = result;
                if (result) {
                    activityMovieDetailsBinding.fabActionAddToFavorite.setContentDescription(getString(R.string.DeleteToFavoriteFAB_a11y));
                    activityMovieDetailsBinding.fabActionAddToFavorite.setImageResource(R.drawable.ic_action_favorite);
                } else {
                    activityMovieDetailsBinding.fabActionAddToFavorite.setContentDescription(getString(R.string.AddToFavoriteFAB_a11y));
                    activityMovieDetailsBinding.fabActionAddToFavorite.setImageResource(R.drawable.ic_add_to_fav);
                }
                break;
            case DELETE_FAV_MOVIE:
                activityMovieDetailsBinding.fabActionAddToFavorite.setClickable(true);
