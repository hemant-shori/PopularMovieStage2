...
import com.hemant.popularmovies.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements AllMoviesAdapter.OnMovieClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityMainBinding.buttonNoMovieFoundTryAgain.setOnClickListener(this);
        int columnCount = getColumnAccordingToScreenSize();
        GridLayoutManager gridLayoutManager = new GridLayoutManager(this, columnCount);
        activityMainBinding.rvAllMovies.setLayoutManager(gridLayoutManager);
        activityMainBinding.rvAllMovies.setHasFixedSize(true);
        allMoviesAdapter = new AllMoviesAdapter(this);
        activityMainBinding.rvAllMovies.setAdapter(allMoviesAdapter);
    }
    ...
    private void showDetailsView() {
        activityMainBinding.rvAllMovies.setVisibility(View.VISIBLE);
        activityMainBinding.pbLoadingIndicator.setVisibility(View.GONE);
        activityMainBinding.buttonNoMovieFoundTryAgain.setVisibility(View.GONE);
        activityMainBinding.textViewNoMovieFoundError.setVisibility(View.GONE);
    }

    private void showProgressView() {
        activityMainBinding.rvAllMovies.setVisibility(View.GONE);
    ...
    private void showNoMovieFoundUI() {
        ...
        if (mCurrentRunningPersistentTypeId == FetchMoviesAsyncTaskLoader.LOAD_FAVORITE_MOVIES) {
            activityMainBinding.textViewNoMovieFoundError.setText(getText(R.string.NoFavoriteMovieFound));
            activityMainBinding.textViewNoMovieFoundError.setVisibility(View.VISIBLE);
            activityMainBinding.buttonNoMovieFoundTryAgain.setVisibility(View.GONE);
        } else {
            activityMainBinding.textViewNoMovieFoundError.setVisibility(View.VISIBLE);
            if (!isConnected()) {
                activityMainBinding.textViewNoMovieFoundError.setText(getText(R.string.UnableToConnectToInternet));
                activityMainBinding.buttonNoMovieFoundTryAgain.setVisibility(View.VISIBLE);
            } else {
                activityMainBinding.textViewNoMovieFoundError.setText(getText(R.string.NoMovieFound));
            }
        }
    }
